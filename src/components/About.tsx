      ...
      <div className="bg-white rounded-2xl mx-auto max-w-7xl px-6 lg:px-8 pt-12">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="flex gap-x-4 rounded-2xl bg-black/5 p-6 ring-1 ring-inset ring-white/10 ">
            ...
            otherwise go to waste. By reducing food waste and supporting
            small-scale farmers, FreshFarm is helping to create a more
            sustainable and equitable food system for everyone.
          </p>
        </div>
        <div className="mx-auto mt-12 grid max-w-2xl grid-cols-1 gap-6 sm:mt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8 pb-10">
          {cards.map((card) => (
            <div
              key={card.name}
