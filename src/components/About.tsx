...
const cards = [
  ...
  },
  {
    ...
    description: 'My loyal customers love my produce and I love providing for them!',
    icon: NewspaperIcon,
  },
]
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Fresh Farms provides perfectly imperfect produce to your community.
            </p>
          </div>
          <div
