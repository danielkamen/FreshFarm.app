                            ...
                            <div className="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                              ...
                              <div className="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                                ...
                                <div className="mt-6 text-sm font-medium">
                                  <a href="src/components/Navigation#" className="text-indigo-600 hover:text-indigo-500">
                                    View all posts
                                    <span aria-hidden="true"> &rarr;</span>
                                  </a>
                                </div>
            ...
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                ...
                <div className="mt-6 sm:mt-8">
                  <nav>
                    ...
                    <div className="mt-8 text-base">
                      <a href="src/components/Navigation#" className="font-medium text-indigo-600 hover:text-indigo-500">
                        View all products
                        <span aria-hidden="true"> &rarr;</span>
                      </a>
                    </div>
              ...
              <div className="py-6 px-5">
                <div className="grid grid-cols-2 gap-4">
                  <a href="src/components/Navigation#" className="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">
                    Pricing
                  </a>
                  <a href="src/components/Navigation#" className="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">
                    Docs
