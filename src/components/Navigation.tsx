          ...
          <div className="hidden md:flex md:flex-1 md:items-center md:justify-between">
            ...
            <div className="flex items-center md:ml-12">
              {!user ? (
                ...
                <div className="ml-4 lg:ml-6 flex flex-row items-center">
                  <Link
                    to={CARTPAGE}
                  ...
                  <div className="-my-2 -mr-2">
                    <Menu as="div" className="relative inline-block text-left">
                      <div>
                        <Menu.Button className="items-center inline-flex w-full justify-center rounded-md border border-gray-300 bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100">
                          Options
