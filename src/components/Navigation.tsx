                          ...
                          <Popover.Panel
                            ...
                            <div
                              ...
                              {features.map((item) => (
                                  ...
                                  <span
                                      className="inline-flex h-10 w-10 items-center justify-center rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                                    <item.icon
                                        className="h-6 w-6"
                                        aria-hidden="true"
                                    />
                      ...
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel
                            ...
                            <div
                                className="relative mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                              <nav
                                  className="grid gap-y-10 bg-white px-4 py-8 sm:grid-cols-2 sm:gap-x-8 sm:py-12 sm:px-6 lg:px-8 xl:pr-12"></nav>
                              <div
                                  className="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                ...
                {!user ? (
                    ...
                    <div className="ml-4 flow-root lg:ml-6">
                      <Link
                        ...
                        />
                        <span
                            className="ml-2 text-sm font-medium text-primary group-hover:text-primary-accent">
                      0
                    </span>
