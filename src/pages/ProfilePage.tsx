...
export default function ProfilePage() {
  ...
  const { databaseUserUID, databaseUser, collectionUID, collectionUser } =
    useUserContext();
                          ...
                          <div className="space-y-1 text-center">
                            ...
                            <div className="flex text-sm text-gray-600">
                              <label
                                ...
                                {photo.length !== 0 && (
                                  <img
                                    placeholder={collectionUser?.image_url}
                                    src={photo}
                                    alt="preview-farm"
                                  />
                                )}
